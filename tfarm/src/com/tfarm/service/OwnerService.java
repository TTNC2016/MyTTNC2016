...
public class OwnerService {
	...
	public int add(Owner owner) {
		String sql = "insert into t_owner(fowner_id,fowner_name,fowner_telephone,fowner_sex,fowner_adress,create_time) values('"
	...
	public Map<String, Object> findById(String ownerId) {
		String sql = "select fowner_id,fowner_name,fowner_telephone,fowner_sex,fowner_adress,create_time from t_owner where fowner_id='"
				+ ownerId.trim() + "'";
	...
	public int modify(Owner owner) {
		String sql = "update t_owner set fowner_name='"
				...
				+ owner.getOwnerTelephone().trim()
				+ "',fowner_sex='"+owner.getOwnerSex()+"',modify_time=now() where fowner_id='"
				+ owner.getOwnerId().trim() + "'";
		return this.baseDao.update(sql);
	}

	public List<Map<String, Object>> queryAll() {
		String sql = "select fowner_id,fowner_name,fowner_telephone,fowner_sex,fowner_adress,create_time from t_owner";
